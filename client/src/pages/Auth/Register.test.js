...
describe('Register Component', () => {
  ...
  // Chia Jia Ye A0286580U
  it('should initialise inputs as empty', () => {
    render(
      <MemoryRouter initialEntries={['/register']}>
        <Routes>
          <Route path="/register" element={<Register />} />
    ...
    expect(screen.getByPlaceholderText('What is Your Favorite Sport').value).toBe('');
  });
  ...
  it('should register the user successfully', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('What is Your Favorite Sport'), { target: { value: 'Football' } });
  ...
  // Chia Jia Ye A0286580U
  it('should display error toast when registration success is false', async () => {
